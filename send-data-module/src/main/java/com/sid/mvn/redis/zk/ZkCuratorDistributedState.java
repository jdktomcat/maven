    ...
    public void initMethod() {
        try {
            ...
            NodeCacheListener sendOpenFlgNodeCacheListener = () -> {
                ...
                logger.info(String.format("ZNode【消息发送节点】状态改变,path=%s,data=%s,stat=%s", childData.getPath(), new String(childData.getData(), "UTF-8"), childData.getStat()));
            ...
            NodeCacheListener recycleTaskOpenFlgNodeCacheListener = () -> {
                ...
                logger.info(String.format("ZNode【消息回收定时任务节点】状态改变,path=%s,data=%s,stat=%s", childData.getPath(), new String(childData.getData(), "UTF-8"), childData.getStat()));
            ...
            NodeCacheListener customMessageOpenFlgNodeCacheListener = () -> {
                ...
                logger.info(String.format("ZNode【消息消费节点】状态改变,path=%s,data=%s,stat=%s", childData.getPath(), new String(childData.getData(), "UTF-8"), childData.getStat()));
